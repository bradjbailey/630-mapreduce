...
import org.apache.hadoop.yarn.util.resource.Resources;
 ...
 public class LowestVCoresJobFirstScheduler extends
     AbstractYarnScheduler<FiCaSchedulerApp, FiCaSchedulerNode> implements
     Configurable {
 
   private static final Log LOG = LogFactory.getLog(LowestVCoresJobFirstScheduler.class);
   ...
   public LowestVCoresJobFirstScheduler() {
     super(LowestVCoresJobFirstScheduler.class.getName());
   }
   ...
   @Lock(LowestVCoresJobFirstScheduler.class)
   @Override
