...
import org.apache.hadoop.yarn.util.resource.Resources;
 ...
 public class ShortestJobFirstScheduler extends
     AbstractYarnScheduler<FiCaSchedulerApp, FiCaSchedulerNode> implements
     Configurable {
 
   private static final Log LOG = LogFactory.getLog(ShortestJobFirstScheduler.class);
   ...
   public ShortestJobFirstScheduler() {
     super(ShortestJobFirstScheduler.class.getName());
   }
   ...
   @Lock(ShortestJobFirstScheduler.class)
   @Override
